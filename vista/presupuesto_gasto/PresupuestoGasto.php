...
?>
<script>
Phx.vista.PresupuestoGasto=Ext.extend(Phx.gridInterfaz,{
	...
	onButtonNew: function () {
		...
		Phx.vista.PresupuestoGasto.superclass.onButtonNew.call(this);
	...
	Atributos:[
...

		{
			...
			type:'NumberField',
			bottom_filter: true,
			filters:{pfiltro:'pre_gas.credito_disponible',type:'numeric'},
			id_grupo:2,
			grid:true,
			form:true
		},
	...
	ActList:'../../sis_sigep/control/PresupuestoGasto/listarPresupuestoGasto',
	id_store:'id_presupuesto_gasto',
	fields: [
		{name:'id_presupuesto_gasto', type: 'numeric'},
